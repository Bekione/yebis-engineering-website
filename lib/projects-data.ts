...
export const ALL_PROJECTS: ProjectRecord[] = [
  // ==========================================
  // OFFICIAL VERIFIED WORK PERFORMANCE RECORDS (1 TO 14)
  // ==========================================
  {
    id: "YEB-WP-012",
    recordNumber: 12,
  ...
  },
  {
    ...
    summary:
      "Full construction of a multi-family residential building block under the Addis Ababa City Administration public housing program. Executed complete reinforced concrete skeleton, exterior and interior hollow block masonry, precast floor slab coordination, terrazzo public staircases, and internal plumbing stacks.",
    scopeBreakdown: [
    ...
    technicalSpecs: [
      ...
      { label: "Structural Standard", value: "Ethiopian Building Code Standard (EBCS)" },
      { label: "Masonry Volume", value: "1,200+ m² Hollow Concrete Blocks" },
      { label: "Client Agency", value: "Addis Ababa Housing Dev Project Office" },
    ],
    image: IMG.towers,
    isVerifiedDocumentRecord: true,
    isFeatured: true,
